...
static gatt_server_callback local_gatt_server_callback;
...
void gatt_server_registerCbk(gatt_server_callback cbk)
{
	if(cbk!=NULL)
	{
		...
		ESP_LOGI(GATTS_TAG, "gatt_server_registerCbk OK\n");
		local_gatt_server_callback = cbk;
	}
}
...
static void gatts_profile_a_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param) {
    ...
    case ESP_GATTS_WRITE_EVT:
    {
        ...
        if (!param->write.is_prep){
            ...
            /*Forward the received data to the main application*/
            local_gatt_server_callback(param->write.value, param->write.len);
